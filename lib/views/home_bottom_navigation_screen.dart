...
class _HomeBottomNavigationScreenState
  ...
  username() async {
    phone = await secureStorage.get("username");
    print(phone);
  }
        ...
        return ValueListenableBuilder<int>(
          ...
          builder: (context, value, child) {
            ...
            return Scaffold(
              ...
              appBar:AppConstantsUtils.chk?PreferredSize(
              ...
              body: !controller.isLocationAvailable
                  ...
                  : searchController.text.isNotEmpty
                      ...
                      : currentTab == 4
                          ?AppConstantsUtils.chk?null: const CartPage()
                          : currentTab == 2
                              ?AppConstantsUtils.chk?null: const MyOrders()
                              : currentTab == 3
                                  ? AppConstantsUtils.chk?null:ProfilePage(
                                      nameVal: nameVal, phoneVal: phoneVal)
                                  : Stack(
                                      children: [
                                        Positioned(
                                          top: 0,
                          ...
                          AppConstantsUtils.chk
                              ? showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return Expanded(
                                      child: AlertDialog(
                                        title: Text('Your not login user? '),
                                        content: Text(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          shape: BoxShape.circle,
                                          color:
                                              primaryColor, // inner circle color
                                        ),
                                        child: Center(
                                          child: Text(
